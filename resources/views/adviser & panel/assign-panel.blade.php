            ...
            <main class="content-area">
                <nav aria-label="breadcrumb">
                    ...
                    <div class="container py-4">
                        ...
                        <form>
                            <div class="mb-3">
                                <label class="form-label">Panel Member Name</label>
                                <input type="text" class="form-control" placeholder="Enter panel member name">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Expertise</label>
                                <input type="text" class="form-control" placeholder="Enter area of expertise">
                            </div>
