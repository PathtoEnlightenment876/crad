                ...
                <div class="row g-4 mb-4 d-flex justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100 text-center">
                            <div class="card-body">
                                <h5 class="card-title mb-3">🔎 Archive/Search</h5>
                                <p class="text-muted">Easily access and retrieve past works.</p>
                                <input type="text" class="form-control form-control-sm mb-2" placeholder="Search...">
                                <button class="btn btn-outline-primary btn-sm w-100">Search</button>
                            </div>
                        </div>
                    </div>
