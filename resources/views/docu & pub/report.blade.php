...
<body>
    ...
    <script>
        ...
        function exportTable() {
          ...
          XLSX.writeFile(wb, "Documentation_Publication.xlsx");
        }
      </script>
</body>
