            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    ...
                    <div class="sub-menu collapse" id="module2drop">
                        <a href="{{url('/add-adviser')}}" class="nav-link"><i class="bi bi-list-ul"></i> <span class="description">Add Adviser</span></a>
                        <a href="{{url('/add-panel')}}" class="nav-link"><i class="bi bi-list-ul"></i> <span class="description">Add Panel</span></a>
                        <a href="{{url('/assign-adviser')}}" class="nav-link"><i class="bi bi-list-ul"></i> <span class="description">Assign Adviser</span></a>
                        <a href="{{url('/assign-panel')}}" class="nav-link"><i class="bi bi-list-ul"></i> <span class="description">Assign Panel</span></a>
                ...
                <!-- module 5-->
                <a href="{{url('/analytics.php')}}" class="nav-link text-center">
            ...
            <main class="content-area">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Docu & Publication</li>
                    </ol>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100 text-center">
                            <div class="card-body">
                                ...
                                <p class="text-muted">Manage journals, articles, and research outputs.</p>
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary btn-sm">Add Publication</button>
                                    <button class="btn btn-outline-secondary btn-sm">View List</button>
                                </div>
                            </div>
                        </div>
                    </div>
